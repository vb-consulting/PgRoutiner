...
namespace PgRoutiner
{
    static partial class Program
    {
        ...
        {
            WriteLine(ConsoleColor.Yellow,$"PgRoutiner: {Version}");
            ...
            WriteLine(ConsoleColor.Yellow, " to see the currently selected settings.");
            Write(ConsoleColor.Yellow, "Issues");
            WriteLine(ConsoleColor.Cyan, "   https://github.com/vb-consulting/PgRoutiner/issues");
            Write(ConsoleColor.Yellow, "Donate");
            Write(ConsoleColor.Cyan, "   bitcoincash:qp93skpzyxtvw3l3lqqy7egwv8zrszn3wcfygeg0mv");
            WriteLine(ConsoleColor.Cyan, "   https://www.paypal.com/paypalme/vbsoftware/");
            WriteLine(ConsoleColor.Yellow, $"Copyright (c) VB Consulting and VB Software {DateTime.Now.Year}.", 
