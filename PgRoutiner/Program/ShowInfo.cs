...
namespace PgRoutiner
{
    static partial class Program
    {
        ...
        private static void ShowInfo()
        {
            ...
            WriteSetting(nameof(Settings.SingleLinqMethod), "Linq method name that should be used to yield a single value from enumaration. Default is \"SingleOrDefault\". Other values can be Single, First or FirstOrDefault", "STRING", newLine: true);
