...
namespace PgRoutiner
{
    static partial class Program
    {
        private static void ShowInfo()
        {
            ...
            WriteSetting(nameof(Settings.DiffFilePattern), "Difference script file pattern. {0} is source connection name, {1} is target connection name, {2} is script number and {3} is current date. Set to null or empty to dump difference script content to console output. Default is \"./Database/{0}-{1}/{2}-diff-{3:yyyyMMdd}.sql\".", "FILEPATH");
            WriteSetting(Settings.DiffPgDumpArgs, "File path for pg_dump command for the target connection. Default is pg_dump.", "FILEPATH");
            WriteSetting(nameof(Settings.DiffPrivileges), "Include object privileges in the difference script file. Default is false.");
