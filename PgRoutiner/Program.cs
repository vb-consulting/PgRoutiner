...
namespace PgRoutiner
{
    partial class Program
    {
        ...
        private static void ShowInfo()
        {
            ...
            WriteSetting("connection", "<name> - connection string name, default will use first available from config");
            WriteSetting("project", "<name> - .csproj file name relative to current dir, default will search for first occurrence in current dir");

            WriteSetting("outputDir", "<path> - path for generated source files relative to current, default is current path");
            WriteSetting("modelDir", "<path> - path for model classes source files relative to current, default is null - model classes will be in same file as data access class");

            WriteSetting("schema", "<name> - PostgreSQL schema name, default is public");
            ...
            WriteSetting("namespace", "<name> - namespace for generated source files, default is your project default");

            WriteSetting("notSimilarTo", "<expressions> - NOT SIMILAR TO SQL regular expression for routine names (default is null, skips matching)");
            WriteSetting("similarTo", "<expressions> - SIMILAR TO SQL regular expression for routine names (default is null, skips matching)");

            WriteSetting("sourceHeader", "<string> - string value to be inserted into first line of each file, default is \"// <auto-generated at timestamp />\")");
            ...
            WriteSetting("mapping:key=value", "<type name> - Key is PostgreSQL UDT type name and value is C# type. Use this to override default type mapping or add new type mapping.");
            Console.WriteLine();
            Console.ForegroundColor = ConsoleColor.Yellow;
            Console.WriteLine(
